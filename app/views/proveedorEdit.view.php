...
<p class="text-4xl uppercase text-center font-semibold mb-5 mt-12">Actualización de proveedores</p>
<?php foreach($data as $item):?>
<form class="max-w-md mx-auto mt-3 p-6 shadow-2xl font-semibold border-2 rounded-xl" action="/proveedor/update/<?php echo $item['id'];?>" method="POST">
        <div class="mb-4">
          <label for="text" class="block mb-2 text-base ">Rut</label>
          <input type="text" id="text" name="rut_proveedor" value="<?php echo $item['rut'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ejm: 11.111.111-1" required />
        </div>
        <div class="mb-3">
          <label for="text" class="block mb-2 text-base  text-gray-900">Nombre</label>
          <input type="text" id="text" name="nombre_proveedor" value="<?php echo $item['nombre'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ingrese el nombre del proveedor" required />
        </div>
    ...
    <div class="mb-5">
        <label for="estado" class="block mb-2 text-base text-gray-900 ">Estado</label>
        <select name="estado" id="categorias" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" >
    ...
    >
      <div
        class="bg-orange-600 rounded-xl h-12 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[184px] z-10 duration-500"
      >
